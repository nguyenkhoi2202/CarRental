...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8080/Lab3_CarRental/PayPalServlet";
    public static String vnp_TmnCode = "MZ996I5W";
    public static String vnp_HashSecret = "VJRPOYLTILMIHXZFXYCZTSLTSCKTQAFV";
    ...
    public static String hashAllFields(Map fields) throws UnsupportedEncodingException {
        ...
        sb.append(khoi.connection.Config.vnp_HashSecret);
